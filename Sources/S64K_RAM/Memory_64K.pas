{$N+}
{
        Program Name : Memory
        Package Name : CEF
        Purpose      : Simple 64K RAM component
        Institution  : 
        ...
        *************************************************************
          ...
          7-Apr-2006                Load to our lowest address, not
                                    to 0 (which may be outside our
                                    range).                        
	  ...
	  The memory is infinitely fast (as far as the Emulator is concerned),
        single-port, static RAM, with a maximum address size of 16 bits.
...
type TCEF_64K_Memory_Memory = class ;

     TCEF_64K_Memory = class( TBase_Component )
                           private // Instance data...
                               _Memory : TCEF_64K_Memory_Memory ;
                               _Tag : longint ;
                               _Parent : TComponent ;
     ...
     TCEF_64K_Memory_Memory = class( TBase_Memory )
...
type TCEF_Memory_Debugger = class( TText_Debugger )
                                ...
                                public { API... }
                                    ...
                                    property Memory : TCEF_64K_Memory
                                                 read _Memory
                                                 write _Memory ;
                            end ;
...
constructor TCEF_64K_Memory_Memory.Create ;
...
destructor TCEF_64K_Memory_Memory.Destroy ;
...
procedure TCEF_64K_Memory_Memory.Clear_Memory ;
...
function TCEF_64K_Memory.Default_Input : TComponent ;
...
function TCEF_64K_Memory.Default_Output : TComponent ;
...
procedure TCEF_64K_Memory_Memory.Load_File( const S : string ) ;
...
function TCEF_64K_Memory_Memory.Watchpoint_At( Address : int64 ) : TCEF_Watchpoint ;
...
function TCEF_64K_Memory.Memory : TMemory ;
...
function TCEF_64K_Memory.Facility_Code : longint ;
...
function TCEF_64K_Memory.Initialize( UI : TUI_Interface ) : TUnified_Exception ;
...
begin
    ...
    _Memory := TCEF_64K_Memory_Memory.Create ;
    _Memory._UI := UI ;
    _Memory.Parent := self ;
...
function TCEF_64K_Memory.Terminate : TUnified_Exception ;
...
function TCEF_64K_Memory.Clear_Watchpoint( Address : int64 ; Memory : boolean ;
...
function TCEF_64K_Memory.Component_Type : longint ;
...
function TCEF_64K_Memory.Connect_Input( Component : TComponent ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Connect_Output( Component : TComponent ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Debugger : TDebug_Interface ;
...
function TCEF_64K_Memory.Deposit( Address : int64 ; Size : longint ;
    Buffer : pointer ; Memory : boolean ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Disconnect_Input( Component : TComponent ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Disconnect_Output( Component : TComponent ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Examine( Address : int64 ; var Size : longint ;
    Buffer : pointer ; Memory : boolean ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Get_Access_Mode( Address : int64 ;
...
function TCEF_64K_Memory.Get_Profiling : boolean ;
...
function TCEF_64K_Memory.Get_Read_Latency : longint ;
...
function TCEF_64K_Memory.Get_Write_Latency : longint ;
...
function TCEF_64K_Memory.Input_Component( Index : longint ) : TComponent ;
...
const _Name : PChar = 'CEF Generic 64K memory'#0 ;

function TCEF_64K_Memory.Name : PChar ;
...
function TCEF_64K_Memory.Output_Component( Index : longint ) : TComponent ;
...
function TCEF_64K_Memory.Read( Address : int64 ; Size : longint ;
...
end ; { TCEF_64K_Memory.Read }


function TCEF_64K_Memory.Restore_Contents( Stream : TCOM_Stream ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Restore_State( Stream : TCOM_Stream ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Save_Contents( Stream : TCOM_Stream ): TUnified_Exception ;
...
end ; { TCEF_64K_Memory.Save_Contents }


function TCEF_64K_Memory.Save_State( Stream : TCOM_Stream ) : TUnified_Exception ;
...
function TCEF_64K_Memory.Set_Access_Mode( Low, High : int64 ; Memory : boolean ;
...
procedure TCEF_64K_Memory.Set_Profiling( _On, Children : boolean ) ;
...
procedure TCEF_64K_Memory.Set_Read_Latency( Value : longint ) ;
...
function TCEF_64K_Memory.Set_Watchpoint( Address : int64 ; Memory : boolean ;
            Access : longint ) : TUnified_Exception ;
...
procedure TCEF_64K_Memory.Set_Write_Latency( Value : longint ) ;
...
procedure TCEF_64K_Memory.Show_Status ;
...
function TCEF_64K_Memory.Write( Address : int64 ; Value, Size : longint ;
...
function TCEF_64K_Memory_Memory.Facility_Code : longint ;
...
function TCEF_64K_Memory_Memory.Set_Address_Range( Low, High : int64 ) : TUnified_Exception ;
...
procedure TCEF_64K_Memory_Memory.Get_Address_Range( var Low, High : int64 ) ;
...
procedure TCEF_64K_Memory.Set_Tag( Value : longint ) ;
...
function TCEF_64K_Memory.Get_Tag : longint ;
...
function TCEF_64K_Memory.Get_Parent : TComponent ;
...
procedure TCEF_64K_Memory.Set_Parent( Component : TComponent ) ;
...
procedure TCEF_64K_Memory.Set_Up( P : PChar ) ;
...
begin
    ...
    Parser.Free ;
end ; // TCEF_64K_Memory.Set_Up


function TCEF_64K_Memory.Get_Logger : TCEF_Logger ;
...
procedure TCEF_64K_Memory.Set_Logger( Value : TCEF_Logger ) ;
...
procedure TCEF_64K_Memory_Memory.Dump( Start, Size : int64 ; Buffer : pointer ) ;
...
procedure TCEF_64K_Memory_Memory.Load( Start, Size : int64 ; Buffer : pointer ) ;
...
function TCEF_64K_Memory_Memory.Map_Virtual_To_Physical( Virt : int64 ) : int64 ;

begin
    Result := integer( @Data ) + Virt - _Low ;
end ;
...
const Memory_Facility_Name : PChar = 'CEF 64K Memory' ;
