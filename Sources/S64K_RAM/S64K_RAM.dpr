...
function Make_Instance( Serial_Number : integer ; UI : TUI_Interface ) : TCEF_64K_Memory ;
    stdcall ;

begin
    Result := TCEF_64K_Memory.Create ;
...
begin
    ...
    Result := Create_Component_Query( Component_Type_Memory, S, '64K Static RAM' ) ;
end ;
