{
        Program Name : CEFClock
        Package Name : CEF
        Purpose      : Generic CEF clock component
        ...
        *************************************************************
          ...
          This is the default clock component for CEF32.
...
function Make_Instance( Serial_Number : integer ;
    UI : TUI_Interface ) : TCEF_Generic_Clock ; stdcall ;

begin
    Result := TCEF_Generic_Clock.Create ;
...
begin
    ...
    Result := Create_Component_Query( Component_Type_Unknown, S, 'CEF master clock' ) ;
end ;
