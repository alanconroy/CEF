...
type TCEF_64K_Memory_Memory = class ;
     ...
     TCEF_64K_Memory = class( TComponent )
     ...
     TCEF_64K_Memory_Memory = class( TMemory )
...
function TCEF_64K_Memory_Memory.Set_Error( Code : integer ) : TUEC ;
...
function TCEF_64K_Memory.Initialize( UI : TUI_Interface ) : TUEC ;
...
function TCEF_64K_Memory.Terminate : TUEC ;
...
function TCEF_64K_Memory.Connect_Input( Component : TComponent ) : TUEC ;
...
function TCEF_64K_Memory.Connect_Output( Component : TComponent ) : TUEC ;
...
function TCEF_64K_Memory.Disconnect_Input( Component : TComponent ) : TUEC ;
...
function TCEF_64K_Memory.Disconnect_Output( Component : TComponent ) : TUEC ;
...
function TCEF_64K_Memory.Restore_Contents( Stream : TCOM_Stream ) : TUEC ;
...
function TCEF_64K_Memory.Restore_State( Stream : TCOM_Stream ) : TUEC ;
...
function TCEF_64K_Memory.Save_Contents( Stream : TCOM_Stream ): TUEC ;
...
function TCEF_64K_Memory.Save_State( Stream : TCOM_Stream ) : TUEC ;
...
function TCEF_64K_Memory_Memory.Set_Address_Range( Low, High : int64 ) : TUEC ;
