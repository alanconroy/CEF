{$N+}
{
	  ...
	  This unit is the Rockwell AIM 65 keyboard component for CEF.
...
uses // Borland...
     ...
     // AIM65_KB...
     AIM65KB_Main ; // TMain_Form

const AIM65KB_Facility = -1 ;
      AIM65KB_Success = 0 ;
      AIM65KB_Component_Not_Found = 1 ;
      AIM65KB_Invalid_Component = 2 ;
      AIM65KB_No_Matching_Watchpoint = 3 ;

type TAIM65KB_UI = class ;
     TAIM65KB_KB = class ;

     TAIM65KB = class( TBase_Component )
                   ...
                   public { Public instance data... }
                       ...
                       _User_Interface : TAIM65KB_UI ;
                       _Keyboard : TAIM65KB_KB ;
     ...
     TAIM65KB_UI = class( TBase_User_Interface )
     ...
     TAIM65KB_KB = class( TBase_Keyboard )
                      private // Instance data...
                          Parent : TAIM65KB ;
                          Temp_Key : string ;
...
{ TAIM65KB_Debugger methods... }

type TAIM65KB_Debugger = class( TText_Debugger )
                                private
                                    _Memory : TAIM65KB ;
                                ...
                                public { API... }
                                    ...
                                    property Memory : TAIM65KB
                                                 read _Memory
                                                 write _Memory ;
                            end ;

function TAIM65KB_Debugger.Child( Ordinal : longint ) : PDebug_Interface ;
...
function TAIM65KB_Debugger.Count : longint ;
...
constructor TAIM65KB_UI.Create ;
...
destructor TAIM65KB_UI.Destroy ;
...
function TAIM65KB_UI.Translate_Error( Code : longint ) : string ;

var _Error : string ;

begin
    case Code of
        AIM65KB_Success: _Error := 'Success' ;
        AIM65KB_Component_Not_Found : _Error := 'Component not found' ;
        AIM65KB_Invalid_Component : _Error := 'Invalid component' ;
        AIM65KB_No_Matching_Watchpoint : _Error := 'No Matching Watchpoint' ;
...
function TAIM65KB_UI.Get_Hidden : boolean ;
...
procedure TAIM65KB_UI.Set_Hidden( Value : boolean ) ;
...
function TAIM65KB_UI.Get_Parent_Window : THandle ;
...
procedure TAIM65KB_UI.Set_Parent_Window( Value : THandle ) ;
...
function TAIM65KB_UI.Optimal_Height : integer ;
...
function TAIM65KB_UI.Optimal_Width : integer ;
...
function TAIM65KB_KB.Get_Key : PChar ;
...
function TAIM65KB_KB.Get_Key_Down( Name : PChar ) : boolean ;
...
function TAIM65KB_KB.Get_Key_Name( Index : integer ) : PChar ;
...
procedure TAIM65KB_KB.Add_Key( Key : string ; Value, Up : integer ) ;
...
function TAIM65KB.Default_Input : TComponent ;
...
function TAIM65KB.Default_Output : TComponent ;
...
function TAIM65KB.User_Interface : TUser_Interface ;
...
function TAIM65KB.Keyboard : TKeyboard ;

begin
    if( _Keyboard = nil ) then
    begin
        _Keyboard := TAIM65KB_KB.Create ;
...
function TAIM65KB.Facility_Code : longint ;

begin
    Facility_Code := AIM65KB_Facility ;
end ;


function TAIM65KB.Initialize( UI : TUI_Interface ) : TUnified_Exception ;
...
begin
    ...
    begin
        ...
        _User_Interface := TAIM65KB_UI.Create ;
        _User_Interface.Parent := self ;
        _User_Interface.Main_Form._UI := UI ;
        _User_Interface.Main_Form._AIM65KB := self ;
    end ;
    Initialize := _User_Interface.Set_Error( AIM65KB_Success ) ;
end ; { TAIM65KB.Initialize }


function TAIM65KB.Terminate : TUnified_Exception ;
...
begin
    ...
    Outputs.Free ;
    Outputs := nil ;
    Terminate := _User_Interface.Set_Error( AIM65KB_Success ) ;
    _User_Interface.Free ;
    _User_Interface := nil ;
    _Keyboard.Free ;
    _Keyboard := nil ;
    Free ;
end ; { TAIM65KB.Terminate }



function TAIM65KB.Clear_Watchpoint( Address : int64 ; Memory : boolean ;
...
function TAIM65KB.Component_Type : longint ;
...
function TAIM65KB.Connect_Input( Component : TComponent ) : TUnified_Exception ;

begin
    if( Component = nil ) then
    begin
        Connect_Input := _User_Interface.Set_Error( AIM65KB_Invalid_Component ) ;
        exit ;
    end ;
    Inputs.Add( Component ) ;
    Connect_Input := _User_Interface.Set_Error( AIM65KB_Success ) ;
end ;


function TAIM65KB.Connect_Output( Component : TComponent ) : TUnified_Exception ;

begin
    if( Component = nil ) then
    begin
        Connect_Output := _User_Interface.Set_Error( AIM65KB_Invalid_Component ) ;
        exit ;
    end ;
    Outputs.Add( Component ) ;
    Connect_Output := _User_Interface.Set_Error( AIM65KB_Success ) ;
end ;


function TAIM65KB.Debugger : TDebug_Interface ;

begin
    Result := TAIM65KB_Debugger.Create ;
    TAIM65KB_Debugger( Result ).Memory := Self ;
end ;


function TAIM65KB.Deposit( Address : int64 ; Size : longint ;
    Buffer : pointer ; Memory : boolean ) : TUnified_Exception ;
...
function TAIM65KB.Disconnect_Input( Component : TComponent ) : TUnified_Exception ;

begin
    if( ( Component = nil ) or ( Inputs.IndexOf( Component ) = -1 ) ) then
    begin
	Disconnect_Input := _User_Interface.Set_Error( AIM65KB_Component_Not_Found ) ;
    end else
    begin
	Disconnect_Input := _User_Interface.Set_Error( AIM65KB_Success ) ;
	Inputs.Remove( Component ) ;
    end ;
end ;


function TAIM65KB.Disconnect_Output( Component : TComponent ) : TUnified_Exception ;

begin
    if( ( Component = nil ) or ( Outputs.IndexOf( Component ) = -1 ) ) then
    begin
	Disconnect_Output := _User_Interface.Set_Error( AIM65KB_Component_Not_Found ) ;
    end else
    begin
	Disconnect_Output := _User_Interface.Set_Error( AIM65KB_Success ) ;
	Outputs.Remove( Component ) ;
    end ;
end ;


function TAIM65KB.Examine( Address : int64 ; var Size : longint ;
    Buffer : pointer ; Memory : boolean ) : TUnified_Exception ;
...
function TAIM65KB.Get_Access_Mode( Address : int64 ;
...
function TAIM65KB.Get_Profiling : boolean ;
...
function TAIM65KB.Get_Read_Latency : longint ;
...
function TAIM65KB.Get_Write_Latency : longint ;
...
function TAIM65KB.Input_Component( Index : longint ) : TComponent ;
...
const _Name : PChar = 'AIM65 Keyboard'#0 ;

function TAIM65KB.Name : PChar ;
...
function TAIM65KB.Output_Component( Index : longint ) : TComponent ;
...
function TAIM65KB.Read( Address : int64 ; Size : longint ;
...
function TAIM65KB.Restore_Contents( Stream : TCOM_Stream ) : TUnified_Exception ;
...
function TAIM65KB.Restore_State( Stream : TCOM_Stream ) : TUnified_Exception ;
...
function TAIM65KB.Save_Contents( Stream : TCOM_Stream ): TUnified_Exception ;
...
function TAIM65KB.Save_State( Stream : TCOM_Stream ) : TUnified_Exception ;
...
function TAIM65KB.Set_Access_Mode( Low, High : int64 ; Memory : boolean ;
...
procedure TAIM65KB.Set_Profiling( _On, Children : boolean ) ;
...
procedure TAIM65KB.Set_Read_Latency( Value : longint ) ;
...
function TAIM65KB.Set_Watchpoint( Address : int64 ; Memory : boolean ;
            Access : longint ) : TUnified_Exception ;
...
procedure TAIM65KB.Set_Write_Latency( Value : longint ) ;
...
procedure TAIM65KB.Show_Status ;
...
function TAIM65KB.Write( Address : int64 ; Value, Size : longint ;
...
procedure TAIM65KB.Set_Tag( Value : longint ) ;
...
function TAIM65KB.Get_Tag : longint ;
...
function TAIM65KB.Get_Parent : TComponent ;
...
procedure TAIM65KB.Set_Parent( Component : TComponent ) ;
...
procedure TAIM65KB.Set_Up( P : PChar ) ;

begin
end ;


const AIM65KB_Facility_Name : PChar = 'AIM65 Keyboard' ;
