{
        Program Name : AIM65KB_Main
        Package Name : CEF
        Purpose      : Rockwell AIM 65 keyboard
        Institution  : Conroy & Conroy Co.
        Date Written : 2-Dec-2007
	...
	Released to the public domain.
        ...
        *************************************************************
          ...
          This is the visual portion of the Rockwell AIM 65 keyboard component
        for CEF.
...
procedure TMain_Form.SpeedButton110Click( Sender : TObject ) ;
    ...
    begin
        TAIM65KB( _AIM65KB )._Keyboard.Add_Key( Name, Value, State ) ;
    end ;
