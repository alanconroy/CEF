{
        Program Name : RL11
        Package Name : CEF
        Purpose      : DEC RL11 CEF component
	...
	Released to the public domain.
        ...
        *************************************************************
          ...
          This component emulates a DEC RL11 disk controller for
        CEF32.
...
begin
    Result := CEFRL11_Facility ;
end ;


function Make_Instance( Serial_Number : integer ; UI : TUI_Interface ) : TRL11 ;
    stdcall ;
...
begin
    ...
    Result := Create_Component_Query( Component_Type_Memory, S, 'DEC RL11 UNIBUS disk interface' ) ;
end ;
