{
	...
	Released to the public domain.
        ...
        *************************************************************
          ...
          This is the visual portion of the DEC LA120 keyboard component for CEF.
...
procedure TMain_Form.SpeedButton110Click( Sender : TObject ) ;
    ...
    begin
        TLA120KB( _LA120KB )._Keyboard.Add_Key( Name, Value, State ) ;
    end ;
